...
BaseSeleniumTest.run(async (test) => {
  ...
  // Wait for the ETH logo image to appear
  await test.waitForElement(By.css('img[src="https://cdn.moralis.io/eth/0x.png"]'), 10000);
  console.log('Treasury page loaded and ETH logo image found.');
}, test);
